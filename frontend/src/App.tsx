...
import { IoTGatewayFleetPage } from './pages/IoTGatewayFleetPage';
      ...
      <AuthProvider>
        <BrowserRouter>
          <Routes>
            ...
            {/* Protected Routes inside Single Main Layout Shell */}
            <Route
              path="/"
              element={
                <ProtectedRoute>
            ...
            >
              ...
              <Route path="sensor-history/:hiveId" element={<SensorHistoryPage />} />
              ...
              <Route path="gateways" element={<IoTGatewayFleetPage />} />
              <Route
                path="users"
                element={
